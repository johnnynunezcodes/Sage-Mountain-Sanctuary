...
// Portrait photos added 2026-08-19, from Website/public/images/Staff/<name>/*-Portrait.jpg —
// see ../../../Images/Appendix.md for the source-to-slug mapping.
...
export interface TeamMember {
  ...
  initials: string
  photoUrl?: string
  // CSS object-position for the portrait crop (e.g. on /about/team's tall
  // sidebar photo) — only needed when the default center crop cuts off the
  // person because the source photo is a wide lifestyle shot, not a
...
export const team: TeamMember[] = [
  {
    ...
    role: "Co-Founder",
    initials: "DS",
    photoUrl: "/images/team/david-swartz.jpg",
    bio: [
  ...
  },
  {
    ...
    role: "Co-Founder",
    initials: "LL",
    photoUrl: "/images/team/lauren-lockey.jpg",
    bio: [
  ...
  },
  {
    ...
    initials: "AP",
    photoUrl: "/images/team/alyssa-poulsen.jpg",
    bio: [
  ...
  },
  {
    ...
    role: "Animal Care Manager",
    initials: "AB",
    photoUrl: "/images/team/alec-brush.jpg",
